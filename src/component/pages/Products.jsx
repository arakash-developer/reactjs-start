          ...
          <div className="pr-10 bg-red">
            ...
            <div className="mt-[35px] mb-[53px] flex flex-col gap-y-5">
              <div className="flex items-center justify-between pb-[19px] border-b">
                <h3 className='font-normal text-base leading-[187%] text-[#767676] font-dm'>Category 1</h3>
                <img src={Path} alt="" />
              </div>
              <div className="flex items-center justify-between pb-[19px] border-b">
                <h3 className='font-normal text-base leading-[187%] text-[#767676] font-dm'>Category 2</h3>
                <img src={Path} alt="" />
              </div>
              <div className="flex items-center justify-between pb-[19px] border-b">
                <h3 className='font-normal text-base leading-[187%] text-[#767676] font-dm'>Category 3</h3>
                <img src={Path} alt="" />
              </div>
              <div className="flex items-center justify-between pb-[19px] border-b">
                <h3 className='font-normal text-base leading-[187%] text-[#767676] font-dm'>Category 4</h3>
                <img src={Path} alt="" />
              </div>
              <div className="flex items-center justify-between pb-[19px] border-b">
                <h3 className='font-normal text-base leading-[187%] text-[#767676] font-dm'>Category 5</h3>
                <img src={Path} alt="" />
              </div>
            </div>
